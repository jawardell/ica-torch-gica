...
SM_NIFTI=/data/users2/jwardell1/ica-torch-gica/standalone_gica_script/group_level_analysis/NeuroMark_resampled.nii
...
matlab -batch "setenv('inputArg1', '${FMRI_NIFTI}'); setenv('inputArg2', '${SM_NIFTI}'); setenv('inputArg3', '${SUBID}'); setenv('inputArg4', '${MASK_NIFTI}'); run('${SCRIPT}')"
